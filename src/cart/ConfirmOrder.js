...
const ConfirmOrder = () => {
    ...
    const itemsPrice = cartItems.reduce((acc, item) => acc.item.price + item.price * item.quantity,0)
        ...
        <Fragment>
            ...
            <div className="row d-flex justify-content-between">
                <div className="col-12 col-lg-8 mt-5 order-confirm">
                    ...
                    {cartItems.map((item) => (
                        <div className="row" key={item.product}>
                            <div className="col-4 col-lg-2">
                                <img src="/images/airpods.jpg" alt="Laptop" height="45" width="65" />
                            </div>
                    ...
                    <hr />
                    <div className="cart-item my-1"></div>
                    <hr />
                </div>
